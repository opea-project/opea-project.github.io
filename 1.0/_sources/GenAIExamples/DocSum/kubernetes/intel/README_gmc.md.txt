...
Install GMC in your Kubernetes cluster, if you have not already done so, by following the steps in Section "Getting Started" at [GMC Install](/GenAIInfra/microservices-connector/README.md#readme). We will soon publish images to Docker Hub, at which point no builds will be required, further simplifying install.
...
[NOTE]
Refer to [Docker Xeon README](/GenAIExamples/DocSum/docker_compose/intel/cpu/xeon/README.md) or
[Docker Gaudi README](/GenAIExamples/DocSum/docker_compose/intel/hpu/gaudi/README.md) to build the OPEA images. 
