...
Upload a video or images using the dataprep microservice, instructions can be found [here](/GenAIComps/comps/dataprep/multimodal/redis/langchain/README.md).
