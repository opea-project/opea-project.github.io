...
For example, if you want to use Nginx to forward the frontend, backend services of a [ChatQnA](/GenAIExamples/ChatQnA/README.md) example, setup environment variables as below.
