...
- [🚀 3. Start Microservice with Python](#start-microservice-with-python): For users who prefer to run the ASR microservice directly with Python scripts.
...
Reference to（[validate the service](#validate-the-service)）
