...
1. [🚀1. Start Microservice with Python (Option 1)](#Start-Microservice-with-Python-Option-1)
2. [🚀2. Start Microservice with Docker (Option 2)](#Start-Microservice-with-Docker-Option-2)
3. [🚀3. Consume Finetuning Service](#Consume-Finetuning-Service)
4. [🚀4. Descriptions for Finetuning parameters](#Descriptions-for-Finetuning-parameters)
