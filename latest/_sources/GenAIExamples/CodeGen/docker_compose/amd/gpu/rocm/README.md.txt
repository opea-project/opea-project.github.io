...
- [Building Docker Images Locally (Optional)](#building-docker-images-locally-optional)
  ...
  - [3. Select Services and Build](#select-services-and-build)
- [Validate Service Health](#validate-service-health)
  - [1. Validate the vLLM/TGI Service](#validate-the-vllmtgi-service)
  - [2. Validate the LLM Service](#validate-the-llm-service)
  - [3. Validate the MegaService (Backend)](#validate-the-megaservice-backend)
  - [4. Validate the Frontend (UI)](#validate-the-frontend-ui)
