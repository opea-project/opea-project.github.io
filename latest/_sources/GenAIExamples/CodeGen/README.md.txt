...
Refer to the [CodeGen helm chart](/GenAIInfra/helm-charts/codegen/README.md) for instructions on deploying CodeGen into Kubernetes on Xeon & Gaudi.
...
1. If you get errors like "Access Denied", [validate micro service](/GenAIExamples/CodeGen/docker_compose/intel/cpu/xeon/README.md#validate-microservices) first. A simple example:
