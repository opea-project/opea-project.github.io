...
5. [Deploy the Service on Arc A770 Using Docker Compose](#deploy-the-service-on-intel-gpu-using-docker-compose)
...
please to [Install Native Environment](https://github.com/intel/llm-scaler/tree/main/vllm#install-native-environment) for detailed setup
