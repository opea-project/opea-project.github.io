...
3. [Run quick_start.sh](#run-quick_startsh)
4. [Access UI](#access-ui)
...
**Driver & libraries**: Please refer to [Install Bare Metal Environment](https://github.com/intel/llm-scaler/tree/main/vllm#install-bare-metal-environment) for detailed setup  
...
If you prefer the manual docker compose cleanup command, please refer to [Manual cleanup details in Advanced Setup](../../../../docs/Advanced_Setup.md#cleanup-the-deployment-manual).
