...
1. [前置条件](#前置条件)
2. [获取代码](#获取代码)
3. [运行 quick_start.sh](#运行-quick_startsh)
4. [访问 UI](#访问-ui)
5. [清理部署](#清理部署)
...
**驱动与库**：详细安装请参考 [Install Bare Metal Environment](https://github.com/intel/llm-scaler/tree/main/vllm#install-bare-metal-environment)  
...
如果你希望使用手动 docker compose 清理命令，请参考 [Advanced Setup 中的手动清理说明](../../../../docs/Advanced_Setup_zh.md#清理部署手动)。
