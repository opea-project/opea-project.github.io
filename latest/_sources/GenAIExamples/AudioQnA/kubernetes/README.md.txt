...
> [NOTE]  
> Please refer to [Xeon README](/GenAIExamples/AudioQnA/docker/xeon/README.md) or [Gaudi README](/GenAIExamples/AudioQnA/docker/gaudi/README.md) to build the OPEA images. These too will be available on Docker Hub soon to simplify use.
