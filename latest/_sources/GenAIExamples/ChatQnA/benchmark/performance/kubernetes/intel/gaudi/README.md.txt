...
- Prepare Shared Models (Optional but Strongly Recommended)
  ...
  - Persistent Volume Claim (PVC): This is the recommended approach for production setups. For more details on using PVC, refer to [PVC](/GenAIInfra/helm-charts/README.md#using-persistent-volume).
