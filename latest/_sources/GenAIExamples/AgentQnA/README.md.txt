...
You can take a look at the tools yaml and python files in this example. For more details, please refer to the "Provide your own tools" section in the instructions [here](/GenAIComps/comps/agent/langchain/README.md#5-customize-agent-strategy).
