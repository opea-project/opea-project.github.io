...
1. **Prepare Test Data**
   ...
   - Download the retrieval file:
     ...
     ```
   - For the `chatqna_qlist_pubmed` test case, prepare `pubmed_${max_lines}.txt` by following this [README](/GenAIEval/evals/benchmark/stresscli/README_Pubmed_qlist.md)
