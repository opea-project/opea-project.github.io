...
1. If you get errors like "Access Denied", [validate micro service](/GenAIExamples/CodeTrans/docker_compose/intel/cpu/xeon/README.md#validate-microservices) first. A simple example:
