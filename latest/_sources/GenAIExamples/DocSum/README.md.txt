...
Refer to the [DocSum helm chart](/GenAIInfra/helm-charts/docsum/README.md) for instructions on deploying DocSum into Kubernetes on Xeon & Gaudi.
...
1. If you get errors like "Access Denied", [validate micro service](/GenAIExamples/DocSum/docker_compose/intel/cpu/xeon/README.md#validate-microservices) first. A simple example:
