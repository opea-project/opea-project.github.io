...
- [Deployment Steps](#deployment-steps)
  - [1. Choose Configuration](#choose-configuration)
  - [2. Prepare Namespace and Deploy](#prepare-namespace-and-deploy)
  - [3. Verify Pod Status](#verify-pod-status)
- [Validation Steps](#validation-steps)
  - [1. Deploy Test Client](#deploy-test-client)
  - [2. Get Service URL](#get-service-url)
  - [3. Send Test Request](#send-test-request)
- [Cleanup](#cleanup)
...
- [GenAI Microservice Connector (GMC)](/GenAIInfra/microservices-connector/README.md) installed in your cluster. Follow the GMC installation guide if you haven't already.
