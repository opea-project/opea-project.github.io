...
Upload a video or images using the dataprep microservice, instructions can be found [here](/GenAIComps/comps/dataprep/redis/multimodal_langchain/README.md).
